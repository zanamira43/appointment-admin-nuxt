<template>
    ...
    <div class="mx-auto max-w-2xl py-20 sm:py-40 lg:py-24">
      <div class="text-center">
        <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Make appointment</h1>
